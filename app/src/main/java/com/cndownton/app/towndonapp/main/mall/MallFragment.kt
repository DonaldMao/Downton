package com.cndownton.app.towndonapp.main.mall
 ...
 * [MallFragment.OnFragmentInteractionListener] interface
...
//            throw RuntimeException(context!!.toString() + " must implement OnFragmentInteractionListener")
    ...
    companion object {
        ...
        fun newInstance(param1: String, param2: String): MallFragment {
